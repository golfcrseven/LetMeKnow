 ...
 */
public class VaccineCostPerWeekFragment extends android.support.v4.app.Fragment {
    DataBaseAdapter db;
    HelperClass hc;
    ...
    public VaccineCostPerWeekFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("title","Add Vaccine(Per Week)");
        ...
        for (int i=1; i<=DrugIdList.size();i++){
            ...
            btnEdt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("module", "vaccine");
                    startActivity(intent);
                }
            });
    ...
    public ArrayList getDrug(Long id, DataBaseAdapter db) {
        ...
        db.open();
        Cursor cursor;
        cursor = db.getRow(db.VACCINE_TABLE, id);
        cursor.requery();
    ...
    private boolean deleted(Long id){
        db.open();
        boolean bool;
        bool =  db.deleteRow(db.VACCINE_COST_TABLE, id);
        db.close();
        return bool;
    }
