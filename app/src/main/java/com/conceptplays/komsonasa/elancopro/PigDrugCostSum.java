...
public class PigDrugCostSum extends android.support.v4.app.Fragment {
    ...
    Double TotalCostSow = 0.0;
    Double TotalCost = 0.0;
    Double TotalCostMonth = 0.0;
    TextView tvTotalCostSow;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvTotalCostSow = (TextView)v.findViewById(R.id.totalCostSow);
        tvTotalCost = (TextView)v.findViewById(R.id.totalCostWeek);
        tvTotalCostMonth = (TextView)v.findViewById(R.id.totalCostMonth);
    ...
    public void setData(){
        ...
        for (int i=1; i<=DrugIdList.size();i++){
            ...
            View custom = infltr.inflate(R.layout.sub_view_drug_cost_sum, null);
            if((position%2)==1)
            ...
            TextView tvSow = (TextView)custom.findViewById(R.id.sum_per_sow);
            TextView tvWeek = (TextView)custom.findViewById(R.id.sum_per_week);
            TextView tvMonth = (TextView)custom.findViewById(R.id.sum_per_month);
            ...
            tvSow.setText(hc.df2(costSow));


            Double cost = (hc.string2double9df(Total.get(position))*hc.string2double(drugList.get(1)));//total*price
            TotalCost = TotalCost+cost;
            tvWeek.setText(hc.df2(cost));

            Double costMonth = (hc.string2double9df(TotalMonth.get(position))*hc.string2double(drugList.get(1)));
