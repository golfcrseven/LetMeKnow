 ...
 */
public class SowDrugCostPerMonthFragment extends android.support.v4.app.Fragment {
    DataBaseAdapter db;
    HelperClass hc;
    ...
    public SowDrugCostPerMonthFragment() {
    ...
    public void getFCH(Double usage){
        ...
        sumVal.set(0,usage*((C4*30)*P4)/1000);
        sumVal.set(1,usage*((C5*30)*P5)/1000);
        sumVal.set(2,usage*((C6*30)*P6)/1000);
        sumVal.set(3,usage*((C7*30)*P7)/1000);
        sumVal.set(4,usage*((C8*30)*P8)/1000);
        sumVal.set(5,usage*((C9*30)*P9)/1000);
        sumVal.set(6,usage*((C10*30)*P10)/1000);
        sumVal.set(7,usage*((C11*30)*P11)/1000);
        sumVal.set(8,usage*((C12*30)*P12)/1000);
        sumVal.set(9,usage*((C13*30)*P13)/1000);
        sumVal.set(10,usage*((C14*30)*P14)/1000);
        sumVal.set(11,usage*((C15*30)*P15)/1000);
        sumVal.set(12,usage*((C16*30)*P16)/1000);
        sumVal.set(13,usage*((C17*30)*P17)/1000);
        sumVal.set(14,usage*((C18*30)*P18)/1000);
        sumVal.set(15,usage*((C19*30)*P19)/1000);
        sumVal.set(16,usage*((C20*30)*P20)/1000);
        sumVal.set(17,usage*((C21*30)*P21)/1000);
        sumVal.set(18,usage*((C22*30)*P22)/1000);
        sumVal.set(19,usage*((C23*30)*P23)/1000);
        sumVal.set(20,usage*((C24*30)*P24)/1000);
        sumVal.set(21,usage*((C25*30)*P25)/1000);
    }
