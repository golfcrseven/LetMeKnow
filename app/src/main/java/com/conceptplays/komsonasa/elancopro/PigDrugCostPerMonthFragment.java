 ...
 */
public class PigDrugCostPerMonthFragment extends android.support.v4.app.Fragment {
    DataBaseAdapter db;
    HelperClass hc;
    ...
    public PigDrugCostPerMonthFragment() {
    ...
    public void getFCH(Double usage) {
        ...
        sumVal.set(0, usage * ((M4 * 30) * P4) / 1000);
        sumVal.set(1, usage * ((M5 * 30) * P5) / 1000);
        sumVal.set(2, usage * ((M6 * 30) * P6) / 1000);
        sumVal.set(3, usage * ((M7 * 30) * P7) / 1000);
        sumVal.set(4, usage * ((M8 * 30) * P8) / 1000);
        sumVal.set(5, usage * ((M9 * 30) * P9) / 1000);
        sumVal.set(6, usage * ((M10 * 30) * P10) / 1000);
        sumVal.set(7, usage * ((M11 * 30) * P11) / 1000);
        sumVal.set(8, usage * ((M12 * 30) * P12) / 1000);
        sumVal.set(9, usage * ((M13 * 30) * P13) / 1000);
        sumVal.set(10, usage * ((M14 * 30) * P14) / 1000);
        sumVal.set(11, usage * ((M15 * 30) * P15) / 1000);
        sumVal.set(12, usage * ((M16 * 30) * P16) / 1000);
        sumVal.set(13, usage * ((M17 * 30) * P17) / 1000);
        sumVal.set(14, usage * ((M18 * 30) * P18) / 1000);
        sumVal.set(15, usage * ((M19 * 30) * P19) / 1000);
        sumVal.set(16, usage * ((M20 * 30) * P20) / 1000);
        sumVal.set(17, usage * ((M21 * 30) * P21) / 1000);
        sumVal.set(18, usage * ((M22 * 30) * P22) / 1000);
        sumVal.set(19, usage * ((M23 * 30) * P23) / 1000);
        sumVal.set(20, usage * ((M24 * 30) * P24) / 1000);
        sumVal.set(21, usage * ((M25 * 30) * P25) / 1000);
    }
