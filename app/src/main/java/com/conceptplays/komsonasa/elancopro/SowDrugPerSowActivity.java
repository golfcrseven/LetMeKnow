...
public class SowDrugPerSowActivity extends Activity {
    DataBaseAdapter db;
    HelperClass hc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sow_drug_per_sow);
    ...
    private void update(){
        ...
        db.open();
        long id;
        id = db.updateRow(db.DRUG_SOW_PERSOW_TABLE, cv, ListID);
        db.close();
        if(id>0) {
            finish();
        }
    ...
    private void getData() {
        db.open();
        Cursor cursor;
        cursor = db.getRow(db.DRUG_SOW_PERSOW_TABLE, Long.valueOf(ListID));
        cursor.requery();
    ...
    private void getPSD(){
        ...
        PSD5 = usage*((C4*7)/1000);
        PSD6 = usage*((C5*7)/1000);
        PSD7 = usage*((C6*7)/1000);
        PSD8 = usage*((C7*7)/1000);
        PSD9 = usage*((C8*7)/1000);
        PSD10 = usage*((C9*7)/1000);
        PSD11 = usage*((C10*7)/1000);
        PSD12 = usage*((C11*7)/1000);
        PSD13 = usage*((C12*7)/1000);
        PSD14 = usage*((C13*7)/1000);
        PSD15 = usage*((C14*7)/1000);
        PSD16 = usage*((C15*7)/1000);
        PSD17 = usage*((C16*7)/1000);
        PSD18 = usage*((C17*7)/1000);
        PSD19 = usage*((C18*7)/1000);
        PSD20 = usage*((C19*7)/1000);
        PSD21 = usage*((C20*7)/1000);
        PSD22 = usage*((C21*7)/1000);
        PSD23 = usage*((C22*7)/1000);
        PSD24 = usage*((C23*7)/1000);
        PSD25 = usage*((C24*7)/1000);
        PSD26 = usage*((C25*7)/1000);
